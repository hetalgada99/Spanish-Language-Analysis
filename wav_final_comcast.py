...
# # Set up paths
# input_folder = r"T:\Spanish Language Analysis\Files Copying\Comcast_MXF"  # MXF Source Folder
# output_folder = r"T:\Spanish Language Analysis\Wav Files Conversion\wav_comcast"  # WAV Output Folder
# processing_folder = r"T:\Spanish Language Analysis\Copying HTVMotor_Extreme\Processing_Files"

# wav_log_file_path = os.path.join(output_folder, "wav_comcast_files.txt")
# processed_log_file_path = os.path.join(processing_folder, "comcast_processing_final_stage_files.txt")
# spanish_log_file_path = os.path.join(processing_folder, "comcast_spanish_files.txt")
# delete_wav_log_file_path = os.path.join(processing_folder, "delete_comcast_files.txt")
...
wav_log_file_path = os.path.join(output_folder, "wav_comcast_files.txt")
processed_log_file_path = os.path.join(processing_folder, "comcast_processing_final_stage_files.txt")
spanish_log_file_path = os.path.join(spanish_folder, "comcast_spanish_files.txt")
delete_wav_log_file_path = os.path.join(processing_folder, "delete_comcast_files.txt")
...
def send_email_with_outlook(latest_spanish_file, modified_date):
    ...
    mail.Subject = f'Spanish Language Detected for Comcast: {latest_spanish_file}'
