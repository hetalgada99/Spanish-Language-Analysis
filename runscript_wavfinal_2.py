...
scripts = [
    r"T:\Spanish Language Analysis\Code For All\wav_final_extreme.py",
    r"T:\Spanish Language Analysis\Code For All\wav_final_spotgenie.py",
    r"T:\Spanish Language Analysis\Code For All\wav_final_comcast.py",
    r"T:\Spanish Language Analysis\Code For All\wav_final_yangaroo.py"
]
