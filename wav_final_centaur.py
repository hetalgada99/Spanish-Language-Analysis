...
# # Set up paths
# input_folder = r"T:\Spanish Language Analysis\Files Copying\Centaur MXF" # Update folder path
# output_folder = r"T:\Spanish Language Analysis\Wav Files Conversion\wav_centaur"
# processing_folder = r"T:\Spanish Language Analysis\Copying HTVMotor_Extreme\Processing_Files"


# wav_log_file_path = os.path.join(output_folder, "wav_centaur_files.txt")
# processed_log_file_path = os.path.join(processing_folder, "processing_final_stage_centaur_files.txt")
# spanish_log_file_path = os.path.join(processing_folder, "centaur_spanish_files.txt")
# delete_wav_log_file_path = os.path.join(processing_folder, "delete_wav_centaur_files.txt")
...
wav_log_file_path = os.path.join(output_folder, "wav_centaur_files.txt")
processed_log_file_path = os.path.join(processing_folder, "processing_final_stage_centaur_files.txt")
spanish_log_file_path = os.path.join(spanish_folder, "centaur_spanish_files.txt")
delete_wav_log_file_path = os.path.join(processing_folder, "delete_wav_centaur_files.txt")
...
def send_email_with_outlook(latest_spanish_file, modified_date):
    ...
    mail.Subject = f'Spanish Language Detected for Centaur: {latest_spanish_file}'
