...
# # Set up paths
# input_folder = r"T:\Spanish Language Analysis\Files Copying\Spot Genie MXF" # Update folder path
# output_folder = r"T:\Spanish Language Analysis\Copying HTVMotor_Extreme\wav_spotgenie"
# processing_folder = r"T:\Spanish Language Analysis\Copying HTVMotor_Extreme\Processing_Files"


# wav_log_file_path = os.path.join(output_folder, "wav_sg_files.txt")
# processed_log_file_path = os.path.join(processing_folder, "sg_processing_final_stage_files.txt")
# spanish_log_file_path = os.path.join(processing_folder, "sg_spanish_files.txt")
# delete_wav_log_file_path = os.path.join(processing_folder, "delete_sg_files.txt")
...
wav_log_file_path = os.path.join(output_folder, "wav_sg_files.txt")
processed_log_file_path = os.path.join(processing_folder, "sg_processing_final_stage_files.txt")
spanish_log_file_path = os.path.join(spanish_folder, "sg_spanish_files.txt")
delete_wav_log_file_path = os.path.join(processing_folder, "delete_sg_files.txt")
...
def send_email_with_outlook(latest_spanish_file, modified_date):
    ...
    mail.Subject = f'Spanish Language Detected for Spot Genie: {latest_spanish_file}'
